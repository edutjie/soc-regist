...
class PictureCard extends Component {
  ...
  render() {
    ...
    return (
      <div class="grid grid-cols-4 gap-5 gap-x-14 -ml-6 mt-10">
        {/*1*/}
        <div class="m-auto border-solid border-2 p-3 rounded-2xl bg-white bg-opacity-25 shadow-lg bg-white bg-opacity-25 shadow-lg">
          <div class="">
            <div class="">
              <img
                src={profileImage1}
                alt=""
                id="img"
                class="w-28 h-28 mx-auto block bg-cover rounded-2xl"
              />
            </div>
            <div class="block ">
              <input
              ...
              <label
                for="input1"
                class="rounded-full p-1 py-2 block mt-2 bg-tosca text-white hover:bg-tosca2 text-center"
              >
                <svg
            ...
            <div class="block">
              <label class="block">
                <input
                  type="text"
                  class="border-solid border-2 border-white mt-2 block rounded-full text-sm"
                />
              </label>
            </div>
          </div>
        ...
        {/*2*/}
        <div class="m-auto border-solid border-2 p-3 rounded-2xl bg-white bg-opacity-25 shadow-lg">
          <div class="">
            <div class="">
              <img
                src={profileImage2}
